...
from strawberry_django_jwt2.refresh_token.models import AbstractRefreshToken
from strawberry_django_jwt2.refresh_token.utils import get_refresh_token_model
